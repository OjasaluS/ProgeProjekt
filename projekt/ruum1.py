hint1 = False
def uuesti():
    print("Sinu eluküünal on kustunud.")
...
def algus():
    ...
    print("1.) Võtad tikud ja paned küünla põlema.")
    print("2.) Püüad aegamisi aknani jõuda ja sealt välja vaadata.")
    print("3.) Kobad mööda seinu, äkki leidub kuskil lüliti?")
...
def es_r_1(sisend):
    if sisend == 2:
        ...
        print("1.) Võtad nüüd tikud ja paned küünla põlema.")
        print("2.) Näed kõrvalseinas lülitit, lähed paned tule põlema.")
    ...
    if sisend == 3:
        ...
        print("1.) Võtad nüüd tikud ja paned küünla põlema.")
        print("2.) Lähed vaatan aknast välja, et näha, kus sa olen.")
        valik_es_r_1 = int(input("Valik: "))
    return valik_es_r_1
...
def es_r_3(sisend):
    if sisend == 1:
        if hint1 == True:
            ...
            print('1.) Hakkad vastu. Püüad lüüa ja vabadusse rabeleda.')
            print('2.) Lased end rahulikult kinni võtta. ')
...
def es_r_4(sisend):
    ...
    if sisend == 1:
        ...
        print('1.) Ei anna alla! Võitled lõpuni!')
        print('2.) Ei saa kahe vastu. Langetad rusikad ja alistud.')
        ...
        if valik == 1:
            ...
            print("Su käitumine on nad segadusse ajanud ja selle asemel, et su löökide eest ära põigata, tabad sa mõlemat. Valvurit vajuvad teadvusetult kokku ning sa avastad enda ees vaba ukse ja võimaluse põgeneda.")
            print("Kuidas toimid?")
            print('1.) Põgened üle valvurite kehade ja jooksed ruumist välja.')
            print('2.) Otsustad mitte põgeneda ja jääd oma saatust ootama voodil istudes.')
